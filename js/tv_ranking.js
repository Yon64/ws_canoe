...
//	document.querySelector("#head .name").innerHTML = tCompetition.GetCell('Nom', 0);
	document.querySelector("#head .place").innerHTML = ('RESULTS');
...
function  ShowRankingRow(row, tRanking, i, course_phase)
{
	...
	document.querySelector('#block_ranking .row'+row+' .pena').innerHTML = tRanking.GetCell('Total_pena'+course_phase, i);
