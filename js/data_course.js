...
//	alert("OnCommandRaceLoad :"+JSON.stringify(tCompetition_Course_Phase));

	document.querySelector("#head .gates").innerHTML = tCompetition_Course_Phase.GetCell('Nb_porte', (canoe.GetCodePhase()-1));	
